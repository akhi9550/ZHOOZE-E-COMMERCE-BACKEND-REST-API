...
// func Test_AddAddes(t *testing.T) {
// 	testCase := []struct {
// 		name       string
// 		arg        models.AddressInfo
// 		beforeTest func(mockSQL sqlmock.Sqlmock)
// 		wantErr    error
// 	}{
// 		{
...
// 			},
// 			beforeTest: func(mockSQL sqlmock.Sqlmock) {
// 				expectQuery := `INSERT INTO addresses`
// 				mockSQL.ExpectQuery(expectQuery).
// 					WithArgs(1, "akhil", "chekkiyil house", "cheleri", "kannur", "kerala", "690897").
// 					WillReturnRows(nil)
// 			},
...
// 			beforeTest: func(mockSQL sqlmock.Sqlmock) {
// 				expectQuery := `INSERT INTO addresses`
// 				mockSQL.ExpectQuery(expectQuery).WithArgs("", "", "", "", "", "").
// 					WillReturnError(errors.New("error"))
// 			},
// 			wantErr: errors.New("Error"),
// 		},
...
// 			mockDB, mockSQL, _ := sqlmock.New()
// 			defer mockDB.Close()
// 			gorm, _ := gorm.Open(postgres.New(postgres.Config{
// 				Conn: mockDB,
// 			}), &gorm.Config{})
// 			tt.beforeTest(mockSQL)
// 			u := NewUserRepository(gorm)
// 			err := u.AddAddress(1, tt.arg)
// 			assert.Equal(t, tt.wantErr, err)
// 		})
// 	}
// }
